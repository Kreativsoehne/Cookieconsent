...
$GLOBALS['TL_LANG']['tl_page']['cookieconsent_cookie_link'] = ['Imprint link', 'Link to imprint site.'];
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_page']['cookieconsent_legend'] = 'Cookieconsent information';
