...
$GLOBALS['TL_LANG']['tl_page']['cookieconsent_cookie_link'] = ['Impressum Link', 'Link zur Impressums-Seite.'];
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_page']['cookieconsent_legend'] = 'Cookieconsent Informationen';
