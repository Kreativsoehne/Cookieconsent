...
$GLOBALS['TL_LANG']['tl_ks_cc_service']['CATEGORY'] = ['Kategorie', 'Übergeordnete Kategorie'];
$GLOBALS['TL_LANG']['tl_ks_cc_service']['TYPE'] = ['Typ', 'Typ des Dienst/Cookies, Siehe Dokumentation für Beschreibungen'];
$GLOBALS['TL_LANG']['tl_ks_cc_service']['TYPE_DYNAMIC'] = 'Dynamisches Script';
$GLOBALS['TL_LANG']['tl_ks_cc_service']['TYPE_LOCAL'] = 'Lokales Cookie';
