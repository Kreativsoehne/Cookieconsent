...
class CategoryMigration extends AbstractMigration
{
    ...
    protected function runCategoryMigration(): bool
    {
        $categoryStatement = $this->connection->prepare("
            INSERT INTO `tl_ks_cc_category` (`id`, `tstamp`, `alias`, `published`, `checked`, `wanted`, `needed`, `sorting`, `pid`) VALUES
            (1, 1614777969, 'necessary', '1', '1', '1', '1', 0, 0),
            (2, 1614777939, 'analytics', '1', '', '', '', 0, 0),
            (4, 1614777824, 'presentation', '1', '', '', '', 128, 0),
            (6, 1656500404, 'measurement', '1', '', '', '', 64, 0),
            (7, 1614777909, 'advertising', '1', '', '', '', 0, 0),
            (8, 1614345924, 'recommendations', '', '', '', '', 80, 0),
            (9, 1614777851, 'security', '1', '', '', '', 96, 0);
        ");
